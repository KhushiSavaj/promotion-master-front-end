...
export default function ApplyCampaignFromHome({ handleClose, open, ...props }) {
          ...
          <Grid item md={4} xs={12}>
            <div className={classes.proposalInfo}>
              ...
              <List className={classes.proposalList}>
                ...
                <ListItem><b>Campaign Budget</b><span>${" "} {isEdit ? applyCampaign.price.smi_price 
                  :proposalData ? proposalData.campaign.smi_price : applyCampaign.price.smi_price }</span></ListItem>
              </List>
            </div>
          </Grid>
